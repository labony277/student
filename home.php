...
<td> <form name="reg" action="login.php" method="POST"> <br> <br>
LOGIN: <br> <br>

USERNAME:<input type="text" name="sb"> <br> <br>
PASSWORD:<input type="text" name="sn"> <br> <br>
